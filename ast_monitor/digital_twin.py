class DigitalTwin:
    ...
    def read_control_data(self) -> tuple:
        ...
        """
        return self.current_heart_rate, self.current_duration
    ...
    def predict_heart_rate(self) -> None:
        ...
        while current_time <= self.predicted_duration - 1:
            ...
            average_heart_rate = (
                average_heart_rate +
                (1 / n) * (self.current_heart_rate - average_heart_rate)
            )
            ...
            trimp_delta = (
                ((current_heart_rate - previous_heart_rate) / 2) * time_delta -
            ...
            if self.predicted_heart_rate:
                self.predicted_heart_rate = round(self.predicted_heart_rate)
